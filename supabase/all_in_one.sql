...
-- ===========================================================================
-- BEGIN 0011_listing_ref_code.sql
-- ===========================================================================
...
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/laundromat-bronx-long-lease.jpg', 'Bronx, Bronx', true, 0)
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/laundromat-east-harlem-60-machines.jpg', 'East Harlem, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/laundromat-east-harlem-new-machines.jpg', 'East Harlem, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/cafe-pizzeria-ues.jpg', 'Upper East Side, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/dry-cleaners-lower-east-side.jpg', 'Lower East Side, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/dry-cleaners-bronx-large.jpg', 'Bronx, Bronx', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/laundromat-flushing-full-service.jpg', 'Flushing, Queens', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/laundromat-queens-low-rent.jpg', 'Queens, Queens', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/dry-cleaners-bronx-yankee-stadium.jpg', 'Bronx, Bronx', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/laundromat-washington-heights-absentee.jpg', 'Washington Heights, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/laundromat-harlem-low-rent.jpg', 'Harlem, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/laundromat-harlem-absentee.jpg', 'Harlem, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/barbershop-ues.jpg', 'Upper East Side, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/dry-cleaners-uws.jpg', 'Upper West Side, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/wash-fold-drop-store-ues.jpg', 'Upper East Side, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/laundromat-washington-heights-absentee-run.jpg', 'Washington Heights, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/bagel-shop-cafe-bronx.jpg', 'Bronx, Bronx', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/laundromat-harlem-great-location.jpg', 'Harlem, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/laundromat-astoria-large.jpg', 'Astoria, Queens', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/dry-cleaners-midtown-east.jpg', 'Midtown East, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/greek-turkish-restaurant-tribeca.jpg', 'Tribeca, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
...
insert into public.listing_images (listing_id, url, caption, is_primary, sort_order)
select l.id, v.url, v.caption, v.is_primary, v.sort_order from l, (values
  ('/img/listings/cafe-pizzeria-ues-flagship.jpg', 'Upper East Side, Manhattan', true, 0)
) as v(url, caption, is_primary, sort_order)
where not exists (select 1 from public.listing_images i where i.listing_id = l.id);
insert into public.listing_brokers (listing_id, broker_id)
select l.id, b.id from public.listings l, public.brokers b
