-- =============================================================================
-- NGU Business Real Estate CMS â€” COMPLETE database setup, in one file.
--
-- Paste this whole file into the Supabase SQL Editor and hit Run. It is the
-- concatenation of, in order:
--   migrations/0001_init.sql   â€” schema, RLS, public RPCs
--   migrations/0002_brokers.sqlâ€” brokers + listing/lead attribution
--   seed.sql                   â€” 2 brokers + the 22-listing catalogue
--
-- Safe to re-run: the seed uses ON CONFLICT DO NOTHING / NOT EXISTS guards.
-- Generated by tools/build-all-in-one.ps1 â€” do not hand-edit.
-- =============================================================================
...
-- ============================================================================
-- Business Brokerage CMS â€” initial schema
--
-- Single-tenant: ONE brokerage (you). You (and any staff) log in via Supabase
-- Auth and manage everything. The public site is anonymous â€” visitors browse
...
-- ===========================================================================
-- IDENTITY â€” every authenticated user with a profile row is brokerage staff.
...
-- ===========================================================================
-- LISTINGS â€” businesses for sale
-- ===========================================================================
create table public.listings (
  ...
  -- Financials (nullable â€” not every figure is disclosed)
...
-- ===========================================================================
-- LISTING IMAGES â€” public photos shown on the listing
-- ===========================================================================
...
-- ===========================================================================
-- DOCUMENTS â€” confidential material (CIM, financials). NDA-gated.
...
-- ===========================================================================
-- LEADS â€” inquiries, prospective buyers, prospective sellers. NEVER public.
-- ===========================================================================
...
-- ===========================================================================
-- NDAs â€” signature records. NEVER public. Created via sign_nda() RPC.
-- ===========================================================================
...
-- ===========================================================================
-- PUBLIC RPCs â€” the only way the anonymous site writes data.
-- ===========================================================================
...
-- AUTO-GENERATED by tools/build-catalogue.mjs â€” do not hand-edit.
...
values ('mary-lee', 'Mary Lee', 'Licensed NYS Commercial & Residential Broker Â· Business Sales Consultant', '718-737-6899', 'ngumarylee@gmail.com', 'Maryâ€™s background spans finance, international relations, and small business management. She holds a degree in International Trade from a university in Korea, spent more than ten years with Koreaâ€™s Ministry of Foreign Affairs, and served three years at the United Nations as AttachÃ© to the Korean Mission. She has also owned and operated small businesses herself.
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('laundromat-east-harlem-60-machines', 'sold', false, 'Large Laundromat â€“ East Harlem', '60 machines Â· 2,000 SF plus full basement', 'Laundromat', 'East Harlem', 'NY', 'Manhattan',
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('laundromat-east-harlem-new-machines', 'sold', false, 'Laundromat â€“ New Machines, Large Space', 'Absentee-run Â· employee profit sharing', 'Laundromat', 'East Harlem', 'NY', 'Manhattan',
  null, null, null, null, null, 'Leased', '2,000 SF + 2,000 SF basement', null,
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('cafe-pizzeria-ues', 'sold', false, 'CafÃ© / Restaurant / Pizzeria â€“ Upper East Side', 'Established 2004 Â· pre-pandemic revenue ~$3MM', 'Restaurant / CafÃ©', 'Upper East Side', 'NY', 'Manhattan',
  null, null, 3000000, null, 2004, 'Leased', '1,700 SF + 1,700 SF basement', null,
  'Exact address disclosed after NDA', 'Full cafÃ©/restaurant/pizzeria build-out. Original owners retiring.', 'A long-running Upper East Side cafÃ©, restaurant and pizzeria established in 2004 with pre-pandemic revenue near $3MM. Sold as the original owners retired.',
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('dry-cleaners-lower-east-side', 'sold', false, 'Dry Cleaners â€“ Lower East Side', 'Partial absentee Â· finance-district clientele', 'Dry Cleaners', 'Lower East Side', 'NY', 'Manhattan',
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('dry-cleaners-bronx-large', 'sold', false, 'Dry Cleaners â€“ Large Space', '35+ years Â· the only cleaner in the area', 'Dry Cleaners', 'Bronx', 'NY', 'Bronx',
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('laundromat-flushing-full-service', 'sold', false, 'Laundromat â€“ Full Service, New Machines', '37 years established Â· commuter boulevard location', 'Laundromat', 'Flushing', 'NY', 'Queens',
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('laundromat-queens-low-rent', 'sold', false, 'Laundromat â€“ Long Lease, Low Rent', '50+ years Â· great starter business', 'Laundromat', 'Queens', 'NY', 'Queens',
  139000, 84000, 348000, 2800, null, 'Leased', '600 SF', '10+ year lease',
  'Exact address disclosed after NDA', 'Compact, efficient store with very low rent â€” an ideal first business.', 'A 50+ year Queens laundromat with a standout low rent of $2,800 and a 10+ year lease. About $348k revenue and $84k cash flow â€” a great starter opportunity.',
  (select id from public.brokers where slug = 'mary-lee'))
on conflict (slug) do nothing;
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('dry-cleaners-bronx-yankee-stadium', 'sold', false, 'Dry Cleaners â€“ Close to Yankee Stadium', '40+ years established Â· busy Bronx corridor', 'Dry Cleaners', 'Bronx', 'NY', 'Bronx',
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('laundromat-washington-heights-absentee', 'sold', false, 'Laundromat â€“ Absentee, Long Lease', '14-year lease Â· expansion upside', 'Laundromat', 'Washington Heights', 'NY', 'Manhattan',
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('laundromat-harlem-low-rent', 'sold', false, 'Laundromat â€“ Absentee, Low Rent, Long Lease', '15-year lease Â· coin and drop-off only', 'Laundromat', 'Harlem', 'NY', 'Manhattan',
  450000, 102000, 367000, 4637, null, 'Leased', '1,400 SF', '15-year lease',
  'Exact address disclosed after NDA', 'Absentee-run on a long 15-year lease with low rent. Currently coin and drop-off revenue only.', 'A Harlem laundromat with an exceptional 15-year lease and low rent, ~$367k revenue and ~$102k cash flow from coin and drop-off alone â€” room to add wholesale and delivery.',
  (select id from public.brokers where slug = 'mary-lee'))
on conflict (slug) do nothing;
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('laundromat-harlem-absentee', 'sold', false, 'Laundromat â€“ Absentee, Long Lease', '11-year lease Â· wholesale upside', 'Laundromat', 'Harlem', 'NY', 'Manhattan',
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('barbershop-ues', 'sold', false, 'Barbershop â€“ Long Lease, Low Rent', '5 chairs Â· established Upper East Side clientele', 'Barbershop', 'Upper East Side', 'NY', 'Manhattan',
  95000, 84000, 119000, 2850, null, 'Leased', '500 SF', '8-year lease',
  'Exact address disclosed after NDA', 'Five-chair barbershop with a loyal, established customer base and low rent.', 'A profitable Upper East Side barbershop with five chairs, a loyal clientele, an 8-year lease and low rent â€” ~$119k revenue on ~$84k cash flow.',
  (select id from public.brokers where slug = 'edward-lee'))
on conflict (slug) do nothing;
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('dry-cleaners-uws', 'sold', false, 'Dry Cleaners â€“ Great Location, Long Lease', '30+ years established Â· Upper West Side', 'Dry Cleaners', 'Upper West Side', 'NY', 'Manhattan',
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('wash-fold-drop-store-ues', 'sold', false, 'Wash & Fold Laundry / Drop Store', 'Upper East Side Â· simple drop-store model', 'Laundromat', 'Upper East Side', 'NY', 'Manhattan',
  99000, 70000, 200000, 5600, null, 'Leased', '800 SF + 800 SF basement', '10-year lease',
  'Exact address disclosed after NDA', '8 washers and 8 dryers. Straightforward wash & fold / drop-store with no wholesale accounts.', 'An Upper East Side wash & fold and drop store, 35 years established, with 8 washers/dryers, a 10-year lease, ~$200k revenue and ~$70k cash flow â€” untapped wholesale potential.',
  (select id from public.brokers where slug = 'mary-lee'))
on conflict (slug) do nothing;
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('laundromat-washington-heights-absentee-run', 'sold', false, 'Laundromat â€“ Absentee Run', '31 machines Â· no real-estate tax', 'Laundromat', 'Washington Heights', 'NY', 'Manhattan',
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('bagel-shop-cafe-bronx', 'sold', false, 'Bagel Shop / CafÃ© â€“ Long Lease, Low Rent', 'Luxury residential building Â· ~$936k revenue', 'Restaurant / CafÃ©', 'Bronx', 'NY', 'Bronx',
  399000, null, 936000, 4600, null, 'Leased', '1,500 SF', '10 years + 5-year option',
  'Exact address disclosed after NDA', 'Located in a luxury residential building in an up-and-coming neighborhood. Low rent with no increase for two years and no real-estate tax.', 'A high-volume Bronx bagel shop and cafÃ© in a luxury residential building, ~$936k in revenue, with a long lease and very favorable rent terms.',
  (select id from public.brokers where slug = 'edward-lee'))
on conflict (slug) do nothing;
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('laundromat-harlem-great-location', 'sold', false, 'Laundromat â€“ Great Location, Long Lease', 'All-new equipment Â· ~$135k cash flow', 'Laundromat', 'Harlem', 'NY', 'Manhattan',
  749000, 135000, 445000, 14500, 2022, 'Leased', '1,800 SF + 1,800 SF basement', '10 years + 5-year option',
  'Exact address disclosed after NDA', '35 washers and 36 dryers, all new. Walk-in and drop-off only â€” no commercial accounts yet.', 'A modern, high-performing Harlem laundromat built out about two years ago with all-new equipment, ~$445k revenue and ~$135k cash flow from walk-in/drop-off alone â€” commercial accounts are the obvious next step.',
  (select id from public.brokers where slug = 'mary-lee'))
on conflict (slug) do nothing;
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('laundromat-astoria-large', 'sold', false, 'Laundromat â€“ Astoria, Large Space, Long Lease', '52 newer machines Â· expansion potential', 'Laundromat', 'Astoria', 'NY', 'Queens',
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('dry-cleaners-midtown-east', 'sold', false, 'Dry Cleaners â€“ Great Location', 'Midtown East Â· pickup/delivery upside', 'Dry Cleaners', 'Midtown East', 'NY', 'Manhattan',
  99000, 95000, 394000, 7400, null, 'Leased', '400 SF + 400 SF basement', '5 years + 5-year option',
  'Exact address disclosed after NDA', 'Compact Midtown East plant. Growth opportunity through pickup/delivery and online ordering.', 'A well-located Midtown East dry cleaner, 21 years established (16 under the current owner), with ~$394k revenue and ~$95k cash flow â€” room to grow via pickup/delivery and online.',
  (select id from public.brokers where slug = 'mary-lee'))
on conflict (slug) do nothing;
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('greek-turkish-restaurant-tribeca', 'sold', false, 'Greek / Turkish Restaurant â€“ Tribeca', '4.5-star rated Â· dine-in and delivery', 'Restaurant / CafÃ©', 'Tribeca', 'NY', 'Manhattan',
...
insert into public.listings (slug, status, is_featured, title, headline, category, city, state, county,
  asking_price, cash_flow, gross_revenue, rent, established_year, real_estate, building_sf, lease_expiration,
  location_note, facilities, description, broker_id)
values ('cafe-pizzeria-ues-flagship', 'sold', false, 'CafÃ© / Restaurant / Pizzeria â€“ Upper East Side', 'Established 2004 Â· ~$3MM revenue', 'Restaurant / CafÃ©', 'Upper East Side', 'NY', 'Manhattan',
  999000, 280000, 3000000, 29200, 2004, 'Leased', '1,700 SF + 1,700 SF basement', '10-year lease',
  'Exact address disclosed after NDA', 'Flagship UES cafÃ©/restaurant/pizzeria. Upside via staffing efficiency and menu diversification.', 'A flagship Upper East Side cafÃ©, restaurant and pizzeria established in 2004, with ~$3MM revenue and ~$280k cash flow on a 10-year lease.',
  (select id from public.brokers where slug = 'edward-lee'))
on conflict (slug) do nothing;
