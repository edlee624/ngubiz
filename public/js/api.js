...
(function () {
  ...
  function seedDemoLeads() {
    return [
      ...
      { id: 'l4', type: 'buyer', stage: 'contacted', name: 'Alex Chen', email: 'alex@example.com', phone: '(555) 200-4040', listing_id: 'demo-2', message: 'NDA signed offline; sent the CIM by email.', budget: '', timeframe: '', investment_amount: 700000, interested_categories: ['Restaurant / Café'], source: 'website', created_at: '2026-07-04T09:45:00Z' },
    ];
  }
